...
export const AdminNotificationsPage = () => {
  ...
  if (loading) return <LoadingCard message="Syncing console notifications inbox..." />;
  ...
  return (
    <div className="space-y-6 text-slate-350 select-none max-w-3xl">
      ...
      <div className="flex items-center justify-between border-b border-slate-200 pb-5">
        <div>
          <h2 className="text-xl font-bold text-slate-900 tracking-tight">Console Notifications</h2>
          <p className="text-xs text-slate-600 mt-1">Review dashboard actions, staff adjustments, and refund validations alerts.</p>
        </div>
      ...
      {notifications.length === 0 ? (
        <div className="flex flex-col items-center justify-center p-12 text-center bg-slate-50/10 border border-dashed border-slate-200 rounded-xl text-slate-500 font-medium">
          ...
          <p className="text-sm">No console notifications.</p>
        </div>
      ) : (
          ...
          {notifications.map((n) => (
            ...
            >
              <div className="space-y-1">
                ...
                <span className="text-[9px] text-slate-500 font-semibold block mt-2 uppercase">
